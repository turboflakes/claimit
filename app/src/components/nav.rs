    ...
    html! {
        <footer class="w-full my-8 sm:my-2 dark:bg-gray-900">
            <div class="grid grid-cols-1 2xl:grid-cols-3 gap-4 content-center">
                <div class="inline-flex items-center justify-center 2xl:justify-start mb-2 col-span-3">
                    <div class="inline-flex text-xs text-gray-800 sm:text-center dark:text-gray-400">
            ...
            <div class="grid grid-cols-1 2xl:grid-cols-3 gap-4 content-center">
                <div class="inline-flex items-center justify-center 2xl:justify-start col-span-2 sm:mt-0 order-last 2xl:order-first">
                    <span class="inline-flex text-xs text-gray-800 sm:text-center dark:text-gray-400">
                        ...
                        <a href="https://turboflakes.io/" target="_blank" class="hover:underline hover:underline-offset-2 hover:text-gray-900">
                            <span class="me-4">{"Turboflakes"}</span>
                        </a>
                        <a href="https://turboflakes.io/#/privacy" target="_blank" class="hover:underline hover:underline-offset-2 hover:text-gray-900">
                            <span class="me-4">{"Privacy"}</span>
                        </a>
                        <a href="https://turboflakes.io/#/terms" target="_blank" class="hover:underline hover:underline-offset-2 hover:text-gray-900">
                            <span>{"Terms"}</span>
                        </a>
                    </span>
                </div>
