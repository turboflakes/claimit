...
```bash
cargo run --features chain-spec-pruning --bin subxt chain-spec --url wss://rpc.turboflakes.io:443/westend --output-file common/artifacts/chain_specs/westend.json --state-root-hash --remove-substitutes
