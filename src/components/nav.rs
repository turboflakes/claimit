    ...
    html! {
        <footer class="fixed w-full z-20 bottom-0 start-0 bg-transparent dark:bg-gray-900">
            <div class="flex flex-wrap items-center justify-between mx-4 p-4">
                ...
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">{"© 2024 Claimeer built by "}<a href="https://turboflakes.io/" class="hover:underline hover:text-gray-900">{"Turboflakes"}</a></span>
                <a href="https://github.com/turboflakes/claimeer" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
